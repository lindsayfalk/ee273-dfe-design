* Customized PTM 45nm NMOS for statistical local variations based on Pelgrom model.
...
+dtox = 6.5e-10    lint = -2.5e-09
+vth0 = 0.369+dvth0    k1 = 0.441    u0 = 0.05125    vsat = 147390
+rdsw = 155    ndep = 2.29e+18    xj = 2.4e-08
...
+dmcg    = 66e-9        dmci    = 44e-9        dmdg    = 33e-9        dmcgt   = 66e-9
+dwj     = 0.0e-008     xgw     = 88e-9        xgl     = 0e-008     
