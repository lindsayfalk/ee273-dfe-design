* Customized PTM 45nm PMOS for statistical local variations based on Pelgrom model.
...
+dtox = 7.5e-10    lint = -2.5e-09
+vth0 = -0.31+dvth0    k1 = 0.394    u0 = 0.00642    vsat = 70000
+rdsw = 155    ndep = 1.63e+18    xj = 2.4e-08
